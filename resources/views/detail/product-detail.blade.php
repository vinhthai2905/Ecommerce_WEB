...
<!-- Mirrored from themegenix.net/html/bemet/shop-details.html by HTTrack Website Copier/3.x [XR&CO'2014], Mon, 27 Nov 2023 02:25:57 GMT -->
                    ...
                    <div class="col-lg-6">
                        <div class="shop-details-images-wrap">
                            <div class="tab-content" id="myTabContent">
                                ...
                                <div class="tab-pane" id="itemTwo-tab-pane" role="tabpanel"
                                ...
                                <div class="tab-pane" id="itemThree-tab-pane" role="tabpanel"
                            ...
                            <div class="tab-content" id="descriptionTabContent">
                                <div class="tab-pane fade show active" id="description-tab-pane" role="tabpanel"
                                    ...
                                    <div class="product-description-content">
                                        <p>committed are products that have been produced using sustainable fibers or
                                            processes, reducing their environmental impact. Umino’s goal is to support
                                            the implementation of practices more committed to the environment. I am like
                                            a freight train. Working on the details, twisting and playing with them over
                                            the years, but always staying on the same track I design from instinct. It’s
                                            the only way I know how to live.</p>
                                        <ul class="list-wrap">
                                ...
                                <div class="tab-pane fade" id="reviews-tab-pane" role="tabpanel"
                                    ...
                                    <div class="product-desc-review">
                                        ...
                                        <div class="comment-respond">
                                            ...
                                            <form class="comment-form" action="{{ route('post-comment', $product->id) }}"
                                                method="POST">
                                                @csrf
                                                <!-- Product ID -->
                                                <div class="form-grp">
                        ...
                        <div class="col-lg-4 col-md-6 col-sm-8">
                            <div class="footer-widget">
                                ...
                                <div class="footer-instagram">
                                    <ul class="list-wrap">
                                        <li><a href="#"><img src="assets/img/images/footer_insta01.jpg"
                                                    alt=""></a></li>
                                        <li><a href="#"><img src="assets/img/images/footer_insta02.jpg"
                                                    alt=""></a></li>
                                        <li><a href="#"><img src="assets/img/images/footer_insta03.jpg"
                                                    alt=""></a></li>
                                        <li><a href="#"><img src="assets/img/images/footer_insta04.jpg"
                                                    alt=""></a></li>
                                        <li><a href="#"><img src="assets/img/images/footer_insta05.jpg"
                                                    alt=""></a></li>
                                        <li><a href="#"><img src="assets/img/images/footer_insta06.jpg"
                                                    alt=""></a></li>
                                        <li><a href="#"><img src="assets/img/images/footer_insta07.jpg"
                                                    alt=""></a></li>
                                        <li><a href="#"><img src="assets/img/images/footer_insta08.jpg"
                                                    alt=""></a></li>
                                    </ul>
                                </div>
                            </div>
...
<!-- Mirrored from themegenix.net/html/bemet/shop-details.html by HTTrack Website Copier/3.x [XR&CO'2014], Mon, 27 Nov 2023 02:26:00 GMT -->
